...
std::string QuicFrameTypeToString(QuicFrameType t) {
  switch (t) {
    ...
    RETURN_STRING_LITERAL(MC_CHANNEL_JOIN_FRAME)
    RETURN_STRING_LITERAL(MC_CHANNEL_PROPERTIES_FRAME)
    RETURN_STRING_LITERAL(MC_CHANNEL_LEAVE_FRAME)
    RETURN_STRING_LITERAL(MC_CHANNEL_INTEGRITY_NO_LENGTH_FRAMEX)
    RETURN_STRING_LITERAL(MC_CHANNEL_INTEGRITY_FRAMEX)
    RETURN_STRING_LITERAL(MC_CHANNEL_STREAM_BOUNDARY_FRAMEX)
    RETURN_STRING_LITERAL(MC_CHANNEL_ACK_FRAMEX)
    RETURN_STRING_LITERAL(MC_PATH_RESPONSE_FRAMEX)
    RETURN_STRING_LITERAL(MC_CLIENT_LIMITS_FRAME)
    RETURN_STRING_LITERAL(MC_CHANNEL_RETIRE_FRAME)
    RETURN_STRING_LITERAL(MC_CLIENT_CHANNEL_STATE_FRAME)
...
std::string QuicIetfFrameTypeString(QuicIetfFrameType t) {
  ...
  switch (t) {
    ...
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_PROPERTIES);
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_JOIN);
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_LEAVE);
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_INTEGRITY_NO_LENGTHX);
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_INTEGRITYX);
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_STREAM_BOUNDARYX);
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_ACKX);
    RETURN_STRING_LITERAL(IETF_MC_PATH_RESPONSEX);
    RETURN_STRING_LITERAL(IETF_MC_CLIENT_LIMITS);
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_RETIRE);
    RETURN_STRING_LITERAL(IETF_MC_CLIENT_CHANNEL_STATE);
    default:
