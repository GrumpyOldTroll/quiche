...
std::string QuicFrameTypeToString(QuicFrameType t) {
  switch (t) {
    ...
    RETURN_STRING_LITERAL(MC_CHANNEL_ANNOUNCE_FRAME)
...
std::string QuicIetfFrameTypeString(QuicIetfFrameType t) {
  ...
  switch (t) {
    ...
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_ANNOUNCE_V4);
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_ANNOUNCE_V6);
    ...
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_ACK);
    RETURN_STRING_LITERAL(IETF_MC_CHANNEL_ACK_ECN);
