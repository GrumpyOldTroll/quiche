...
std::string QuicFrameTypeToString(QuicFrameType t) {
  switch (t) {
    ...
    RETURN_STRING_LITERAL(MC_ANNOUNCE_FRAME)
    RETURN_STRING_LITERAL(MC_KEY_FRAME)
    RETURN_STRING_LITERAL(MC_JOIN_FRAME)
    RETURN_STRING_LITERAL(MC_LEAVE_FRAME)
    RETURN_STRING_LITERAL(MC_INTEGRITY_FRAMEX)
    RETURN_STRING_LITERAL(MC_LIMITS_FRAME)
    RETURN_STRING_LITERAL(MC_RETIRE_FRAME)
    RETURN_STRING_LITERAL(MC_STATE_FRAME)
...
std::string QuicIetfFrameTypeString(QuicIetfFrameType t) {
  ...
  switch (t) {
    ...
    RETURN_STRING_LITERAL(IETF_MC_ANNOUNCE_V4);
    RETURN_STRING_LITERAL(IETF_MC_ANNOUNCE_V6);
    RETURN_STRING_LITERAL(IETF_MC_KEY);
    RETURN_STRING_LITERAL(IETF_MC_JOIN);
    RETURN_STRING_LITERAL(IETF_MC_LEAVE);
    RETURN_STRING_LITERAL(IETF_MC_INTEGRITY_NO_LENGTHX);
    RETURN_STRING_LITERAL(IETF_MC_INTEGRITYX);
    RETURN_STRING_LITERAL(IETF_MC_ACK);
    RETURN_STRING_LITERAL(IETF_MC_ACK_ECN);
    RETURN_STRING_LITERAL(IETF_MC_LIMITS);
    RETURN_STRING_LITERAL(IETF_MC_RETIRE);
    RETURN_STRING_LITERAL(IETF_MC_STATE);
    default:
